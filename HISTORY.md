...
+ **Trello** - облачная программа для управления проектами небольших групп. Trello использует парадигму для управления проектами, известную как канбан.
...
+ **QT** - кросс-платформенный фреймворк, включающий в себя все основные классы, который может потребоваться при разработке ПО, начиная от элементов графического интерфейса и заканчивая сетью, базами данных и XML.
